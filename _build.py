    ...
    <section class="section">
      <div class="container split">
        <form data-contact-form action="https://api.web3forms.com/submit" method="POST" novalidate>
          ...
          <textarea id="msg" name="message" rows="5" placeholder="Tell us about your requirement" required></textarea>
          <p><button type="submit" class="btn" data-submit-label="Send Message">Send Message</button></p>
