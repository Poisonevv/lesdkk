...
def header(active=""):
    return (
        ...
        '        <button type="button" class="lang-current" data-lang-toggle aria-haspopup="listbox" aria-expanded="false" aria-label="Change language">\n'
        '          <span class="lang-current-label" data-lang-current>EN</span>\n'
        '          <span class="lang-caret" aria-hidden="true">\u25be</span>\n'
        '        </button>\n'
        '        <ul class="lang-menu" role="listbox" data-lang-menu>\n'
        '          <li><button type="button" class="lang-option" data-lang="en" role="option" aria-selected="true">EN <span>English</span></button></li>\n'
        '          <li><button type="button" class="lang-option" data-lang="fr" role="option" aria-selected="false">FR <span>Français</span></button></li>\n'
        '        </ul>\n'
        '      </div>\n'
        '    </div>\n'
        '  </div>\n'
